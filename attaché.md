...
> [![Security+](https://images.credly.com/size/110x110/images/80d8a06a-c384-42bf-ad36-db81bce5adce/blob)](https://www.credly.com/badges/f1b26c7c-391b-4310-9577-cad551d178fb/public_url)
...
*RTX Corporation 1000 Wilson Blvd. Arlington, VA 22209*

Operate and maintain the cloud-based infrastructure and software components of the Forcepoint DLP platform. Serve as the Subject Matter Expert (SME) for Forcepoint DLP architecture, configuration, and deployment strategies. Ensure high platform availability and agent health across a global RTX endpoint fleet (Windows & macOS Partner with IT and Cyber Engineering teams to package, test, and deploy DLP agents in enterprise environments. Manage ServiceNow (SNOW) queues and resolve DLP-related trouble tickets, including agent health, connectivity, and infrastructure issues. Monitor system logs and events using SIEM tools (e.g., Splunk) to detect anomalies and validate policy performance. Analyze logs and event data to fine-tune DLP policies, reduce false positives/negatives, and improve detection accuracy. Maintain compliance with KPIs and produce clear, actionable reporting for leadership and stakeholders. Support Information Security teams during incident response activities involving DLP policy enforcement or potential data breaches. Participate in ITIL-aligned change management processes, including testing, approving, and deploying new policies and rulesets.
